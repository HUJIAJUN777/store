...
cursor = con.cursor()
# sql = "create table users(account varchar(10) primary key,username varchar(10),password int(20),country varchar(10),provice varchar(10),street varchar(10),door varchar(10),money double(10,2),registerDate date,bankname varchar(20))"
# cursor.execute(sql)
# con.commit()
# cursor.close()
# con.close()
